...
from stellar_system import Star, StellarSystem, Planetoid, Planetesimal, Protoplanet, Protomoon
from accrete import *

from constants import ECCENTRICITY_COEFF, PROTOPLANET_MASS, SUN_MASS_IN_EARTH_MASSES
